#!/usr/bin/env bash
# ============================================================================
# Postman Generator Plugin — Installation Script
# ============================================================================
...
PLUGIN_NAME="postman-generator"
PLUGIN_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"

echo -e "${CYAN}🔄 Postman Generator Installer${NC}"
echo -e "${CYAN}══════════════════════════════════${NC}"
echo ""
...
echo ""
echo -e "${YELLOW}Usage: Run the postman-generator skill!${NC}"
echo -e "  /postman-generator create new collections and env from <context>"
